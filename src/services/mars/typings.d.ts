...
declare namespace API {
  ...
  type UserGroupEditParams = Merge<UserGroupAddParams, {
    id?: string;
  }>;


  //=====================接口返回结果类型=====================
  type LoginResult = Merge<ResponseResult, {
    captcha?: Captcha;
    payload?: {
      token: string;
    };
  ...
  type UserGroupNameExistResult = Merge<ResponseResult, {
    payload: boolean
  }>;
  // 获取所有access的返回结果
  ...
  type UserGroupSetResult = Merge<ResponseResult, {
