 ...
 * @LastEditTime: 2022-07-28 17:24:43
...
export async function getCaptcha(options?: { [key: string]: any }): Promise<any> {
  return request<API.LoginResult>('/api/login/captcha', {
    method: 'GET',
    ...(options || {}),
  });
};
...
export async function getUserInfo(options?: { [key: string]: any }) {
  return request<API.UserInfoResult>('/api/portal/user/info', {
    method: 'GET',
    ...(options || {}),
  });
}
